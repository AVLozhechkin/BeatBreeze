...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatTreeModule, MatButtonModule, MatIconModule, MatProgressBarModule, MatMenuModule],
...
export class ProviderComponent implements OnInit {
  ...
  private _transformer = (node: TreeNode<Song> | undefined, level: number): FlatNode => {
    if (!node)
    {
      return {
        expandable: false,
